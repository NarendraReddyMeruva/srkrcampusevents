    ...
    try {
      ...
      if (res.data.message) {
        toast({
          ...
          description: "Admin account created. Redirecting to sign in...",
          status: "success",
          duration: 2500,
          isClosable: true,
        });
        setTimeout(() => navigate("/adminsignin"), 2500);
    ...
    >
      ...
      >
        ...
        <Text textAlign="center" mt={4} color="gray.400">
          ...
          <Link to={"/adminsignin"} style={{ color: "#ED8936", fontWeight: "semibold", textDecoration: "underline" }}>
            Sign in!
          </Link>
        </Text>
      </Box>
